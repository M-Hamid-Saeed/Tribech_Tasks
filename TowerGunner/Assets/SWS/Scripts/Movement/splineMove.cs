...
namespace SWS
{
    ...
    { 
        private Action pathCompleteAction; // used on line 201 :)
        private Action pathStartAction; // used on line 201 :)
        private Action homeAction; // used on line 201 :)
        /// <summary> 
        ...
        public void SetAction(Action startAction, Action endAction,Action homeAction = null)
        {
            pathStartAction = startAction;
            pathCompleteAction = endAction;
        ...
        public void StartMove()
        {
            ...
            if(!reverse) pathStartAction?.Invoke();
        ...
        private void ReachedEnd()
        {
            ...
            switch (loopType)
            {
                ...
                case LoopType.pingPong:
                    ...
                    if (reverse) 
                    { 
                        //Debug.Log($"{gameObject.name} >> Home !");
                        pathCompleteAction?.Invoke();
                    }
                    else
                    {
                        //Debug.Log($"{gameObject.name} >> Start !");
                        pathStartAction?.Invoke();
                    }
                    Array.Reverse(waypoints);
                    Initialize();
        ...
        /// <summary>
        public void ResetToStart(string t = null)
        {
